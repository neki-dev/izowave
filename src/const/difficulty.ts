...
export const WAVE_ENEMIES_COUNT_GROWTH = 0.5; // Enemies count growth by wave number
...
export const CHEST_EXPERIENCE_GROWTH = 0.3; // Experience growth by wave number
export const CHEST_RESOURCES = { bronze: 4, silver: 4, gold: 2 }; // Default resources count in chest
export const CHEST_RESOURCES_GROWTH = 0.2; // Resources count growth by wave number
...
export const MINE_RESOURCES_LIMIT = 160; // Maximum amount of resources that mine can
