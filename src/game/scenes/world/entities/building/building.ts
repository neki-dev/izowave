...
import { ComponentBuildingInfo } from '~game/scenes/screen/components/building-info';
...
import { Hexagon } from '~game/scenes/world/hexagon';
...
export class Building extends Phaser.GameObjects.Image {
  ...
  constructor(scene: World, {
    ...
    this.scene.game.events.on(GameEvents.GAMEOVER, () => {
      this.onUnfocus();
      this.onUnclick();
    });
